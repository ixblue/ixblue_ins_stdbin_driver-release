## ixblue_ins_stdbin_driver (noetic) - 0.1.5-1

The packages in the `ixblue_ins_stdbin_driver` repository were released into the `noetic` distro by running `/usr/bin/bloom-release ixblue_ins_stdbin_driver --rosdistro noetic` on `Fri, 13 Nov 2020 22:44:24 -0000`
...
## ixblue_ins_stdbin_driver (kinetic) - 0.1.5-1

The packages in the `ixblue_ins_stdbin_driver` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release ixblue_ins_stdbin_driver --rosdistro kinetic` on `Fri, 13 Nov 2020 22:40:23 -0000`
...
## ixblue_ins_stdbin_driver (melodic) - 0.1.5-1

The packages in the `ixblue_ins_stdbin_driver` repository were released into the `melodic` distro by running `/usr/bin/bloom-release ixblue_ins_stdbin_driver --rosdistro melodic` on `Fri, 13 Nov 2020 22:37:18 -0000`
...
## ixblue_ins_stdbin_driver (noetic) - 0.1.4-1

The packages in the `ixblue_ins_stdbin_driver` repository were released into the `noetic` distro by running `/usr/bin/bloom-release ixblue_ins_stdbin_driver --rosdistro noetic` on `Tue, 27 Oct 2020 09:51:11 -0000`
...
## ixblue_ins_stdbin_driver (kinetic) - 0.1.4-1

The packages in the `ixblue_ins_stdbin_driver` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release ixblue_ins_stdbin_driver --rosdistro kinetic` on `Tue, 27 Oct 2020 09:45:11 -0000`
...
## ixblue_ins_stdbin_driver (melodic) - 0.1.4-1
